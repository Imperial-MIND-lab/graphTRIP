...
# Permutation null for no_clinical_features: 100 permutations x 10 training seeds.
#
...
python -m scripts.permutation_null -m no_clinical_features -p $PERM -s $SEED ${EXTRA_ARGS}
