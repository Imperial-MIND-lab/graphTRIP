...
# Medusa graphTRIP: 1 base job (10) -> 10 jobs (70-79)
ABLATION_START=0
ABLATION_END=49
...
elif [ $JOB_ID -ge $MEDUSA_START ] && [ $JOB_ID -le $MEDUSA_END ]; then
    # Medusa graphTRIP (1 base job × 10 seeds = 10 jobs; 70-79)
    python medusa.py -s $SEED
