...
def main(config_file, output_dir, verbose, debug, seed, config_id=0, job_id=None):
...
if __name__ == "__main__":
    ...
    main(args.config_file, args.output_dir, args.verbose, args.debug, args.seed, args.config_id, args.job_id)
