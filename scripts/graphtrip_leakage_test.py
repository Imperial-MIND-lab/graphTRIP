"""
This scripts trains the main graphTRIP models on the primary dataset, 
...
Outputs:
- outputs/graphtrip/leakage_test/
...
def main(config_file, output_dir, verbose, debug, seed, config_id=0):
    ...
    # Train graphTRIP on shuffled labels ---------------------------------------
    ...
    if not os.path.exists(ex_dir):
        ...
        print(f"graphTRIP leakage test experiment already exists in {ex_dir}.")


if __name__ == "__main__":
    """
    How to run:
    python graphtrip.py -c experiments/configs/graphtrip.json -o outputs/graphtrip/ -s 0 -v -dbg
    """
    ...
    parser.add_argument('-o', '--output_dir', type=str, 
                        default='outputs/graphtrip/', help='Path to the output directory')
